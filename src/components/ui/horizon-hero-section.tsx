...
export const Component: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [{ x: 0, y: 30, z: 300 }]
      ...
      refs.mountains.forEach((mountain, i) => {
        ...
        if (progress < 0.7 && refs.locations) mountain.position.z = refs.locations[i]
      })
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line font-semibold text-white">Full Stack Developer — React · Java · Spring Boot</p>
        </div>
      </div>
